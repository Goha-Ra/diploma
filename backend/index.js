...
mongoose.connect('mongodb+srv://sapiyeva001:04Ng0GPE15CLLt88@cluster0.atlpssi.mongodb.net/ecomDB?retryWrites=true&w=majority&appName=Cluster0');
...
app.post('/signup', async(req,res)=>{
    ...
    console.log("Перед сохранением пользователя:", user); 
...
const fetchUser = async (req, res, next)=>{
    ...
    if(!token){
        ...
        try{
            ...
            res.status(401).send({errors:'please auth using'})
        }
    }
}
